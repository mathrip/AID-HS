...
def plot_abnormalities_direction_subject(subj, features, filename):
    ...
    file = os.path.join(PARAMS_PATH,'asymmetries_abnormality_thresholds.pkl')   
...
def write_prediction_subject(subj, output_file, cohort, filename_model):
    ...
    #predict 
    y_pred, scores = predict_subject(subj, features, cohort.dataset, filename_model)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='predict HS and create report')
